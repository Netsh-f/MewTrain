    ...
    <div>
            ...
            <el-table-column label="操作" width="100">
                <template v-slot:default="scope">
                    <el-button size="mini" type="danger"
                        @click="deletepassenger(scope.row.passenger_phone_number)">删除</el-button>
                </template>
            </el-table-column>

        </el-table>

        <el-table :data="passenger_data" v-show="show_passenger_ticket"
                    ...
                    <template #header>
                        <div class="clearfix">
                            ...
                            <el-button style="float: right; padding: 3px 0"
                                @click="AddPassengerInfo(tableData.id, tableData.name, tableData.phone_number, tableData.id_number)"
        ...
        <el-row v-show="active === 3">
            <div style="margin-top: 30px; margin-left: 50px;margin-right: 50px">
                <el-alert title="恭喜您支付成功，请在未出行订单列表中查看" type="success" effect="dark">
                </el-alert>
            </div>
        </el-row>

        <el-button type="primary" round @click="next" style="margin-left: 500px;margin-top: 30px"
